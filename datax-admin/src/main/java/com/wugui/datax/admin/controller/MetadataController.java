...
public class MetadataController extends BaseController {
    ...
    /**
     * 根据数据源id和HiveInfoDTO创建hive表
     *
     * @param datasourceId 数据源id
     * @param hiveInfoDTO     hive表信息
     * @return
     */
    @PostMapping("/createHiveTable")
    @ApiOperation("根据数据源id和HiveInfoDTO创建hive表")
    public ReturnT<Object> createHiveTable(Long datasourceId, @RequestBody HiveInfoDTO hiveInfoDTO) throws SQLException {
        return hiveService.createTable(datasourceId, hiveInfoDTO);
    }
}
