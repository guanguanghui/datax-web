...
import com.wugui.datax.admin.util.KerberosUtil;
...
public abstract class BaseQueryTool implements QueryToolInterface {
    ...
    public DataSource getConnDataSource(){
        return datasource;
    }
    ...
    private void getDataSource(JobDatasource jobDatasource) throws SQLException {
        ...
        if(jobDatasource.getDatasource().equals(JdbcConstants.HIVE)){
            try {
                KerberosUtil.loginForSubject(userName, AESUtil.decrypt(jobDatasource.getJdbcPassword()));
