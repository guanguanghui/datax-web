...
public class DataxJsonHelper implements DataxJsonInterface {
    ...
    public Map<String, Object> buildHiveReader() {
        ...
        if( hiveReaderDto.getHaveKerberos()!=null && hiveReaderDto.getHaveKerberos()){
        ...
        dataxHivePojo.setHaveKerberos(hiveReaderDto.getHaveKerberos());
        dataxHivePojo.setEncoding(hiveReaderDto.getEncoding());
        dataxHivePojo.setCompress(hiveReaderDto.getCompress());
        dataxHivePojo.setNullFormat(hiveReaderDto.getNullFormat());
        dataxHivePojo.setHadoopConfig(hiveReaderDto.getHadoopConfig());
    ...
    public Map<String, Object> buildHiveWriter() {
        ...
        if(hiveWriterDto.getHaveKerberos()!=null && hiveWriterDto.getHaveKerberos()){
            dataxHivePojo.setKerberosPrincipal(hiveWriterDto.getKerberosPrincipal());
            dataxHivePojo.setKerberosKeytabFilePath(hiveWriterDto.getKerberosKeytabFilePath());
        }

        dataxHivePojo.setHaveKerberos(hiveWriterDto.getHaveKerberos());
        dataxHivePojo.setEncoding(hiveWriterDto.getEncoding());
        dataxHivePojo.setCompress(hiveWriterDto.getCompress());
        dataxHivePojo.setHadoopConfig(hiveWriterDto.getHadoopConfig());
